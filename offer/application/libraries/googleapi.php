...
require_once "social/gmaillib/config.php";
...
require_once 'social/gmaillib/service/Google_Model.php';
require_once 'social/gmaillib/service/Google_Service.php';
require_once 'social/gmaillib/service/Google_ServiceResource.php';
require_once 'social/gmaillib/auth/Google_AssertionCredentials.php';
require_once 'social/gmaillib/auth/Google_Signer.php';
require_once 'social/gmaillib/auth/Google_P12Signer.php';
require_once 'social/gmaillib/service/Google_BatchRequest.php';
require_once 'social/gmaillib/external/URITemplateParser.php';
require_once 'social/gmaillib/auth/Google_Auth.php';
require_once 'social/gmaillib/cache/Google_Cache.php';
require_once 'social/gmaillib/io/Google_IO.php';
require_once('social/gmaillib/service/Google_MediaFileUpload.php');

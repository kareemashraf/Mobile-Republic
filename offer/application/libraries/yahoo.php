<?php
require 'social/yahoolib/globals.php';
require 'social/yahoolib/oauth_helper.php';
...
Class Yahoo {
    ...
    public static function callcontact($consumer_key, $consumer_secret, $guid, $access_token, $access_token_secret, $usePost=false, $passOAuthInHeader=true)
    {

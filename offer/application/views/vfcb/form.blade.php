                ...
                <div class="col-md-offset-1 col-md-10">
                  <div class="form-container">
                    ...
                    <form data-parsley-validate>
                      <div class="form-group" style="position: relative; display:block;margin: 20px auto 30px auto;width: 50%;">
                        <input class="form-control input" type="text" name="fullname" value="" placeholder="Name" required />
                      </div>
                      <div class="form-group" style="position: relative; display:block;margin: 20px auto 30px auto;width: 50%;">
                        <input class="form-control input" type="text" name="bfullname" value="" placeholder=" Business name" required />
                      </div>
                      <div class="form-group" style="position: relative; display:block;margin: 20px auto 30px auto;width: 50%;">
                        <input class="form-control input" type="text" name="postcode" value="" data-parsley-pattern="/[A-Z]{1,2}[0-9]{1,2} ?[0-9][A-Z]{2}/i" placeholder="Post code" required>
                      </div>
                      <div class="form-group" style="position: relative; display:block;margin: 20px auto 30px auto;width: 50%;">
                        <input class="form-control input" type="email" name="email" data-parsley-trigger="change" value="" placeholder="Email address" required />
                      </div>

                      <button type="submit" class="btn callback-btn">Done</button>
                    </form>
                  </div>
                  <div class="row">
                    <div class="col-md-8">

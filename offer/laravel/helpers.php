...
/**
 * gets the country name from the User IP
 * @param  string $ip Users [Remote] IP
 * @return string     Users Country
 */
function get_country($ip)
{
	$url = "http://testdriveauto.co.uk/api/ip2nation.php?ip=" . getenv('REMOTE_ADDR');
